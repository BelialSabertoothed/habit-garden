...
export function RegistrationModal({
  ...
  return (
    ...
    >
      <DialogContent className="max-w-md bg-white/95 backdrop-blur-sm border-green-200 rounded-3xl">
        {/* Vnitřní scrollovatelný wrapper */}
        <div className="max-h-[90vh] overflow-y-auto scrollbar-soft px-6 py-6">
          {!success ? (
            <>
