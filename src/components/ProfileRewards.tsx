    ...
    <div className="space-y-6">
      ...
      >
        <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
          ...
          {/* switch na mobilu v samostatném řádku a zarovnaný doprava */}
            ...
            {badges.map((badge, idx) =>
              badge.unlocked ? (
                <motion.div
                  ...
                  className="relative h-full min-h-[150px] sm:min-h-[170px]"
                >
                  <BadgeIcon
                    type={badge.id}
                    unlocked
                ...
                <motion.div
                  key={badge.id}
                  className={`flex flex-col items-center text-center rounded-xl border px-3 py-4 h-full min-h-[150px] sm:min-h-[170px] ${
                    isDark
