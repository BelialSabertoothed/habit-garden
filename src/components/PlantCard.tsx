...
interface PlantCardProps {
  ...
  theme: "day" | "night";
  disabled?: boolean;
  disabledLabel?: string; // např. "Done today" / "Done this week"
}
...
export function PlantCard({
  ...
  return (
    <div
      ...
      } rounded-2xl p-6 shadow-md hover:shadow-lg transition-all duration-200 border`}
    >
      <div className="flex flex-col items-center gap-4">
        {/* Icon */}
        <div className="w-20 h-20 flex items-center justify-center">
          <div
            className={`bg-gradient-to-br ${stage.color} rounded-full flex items-center justify-center shadow-md transition-all duration-300 ${
              growthStage === "seed"
                ? "w-12 h-12"
                : growthStage === "sprout"
                ? "w-14 h-14"
        ...
        <Button
          ...
          title={disabled ? disabledLabel : "Water this plant"}
        >
